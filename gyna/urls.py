...
urlpatterns = [
    ...
    path('gyna/', views.admin_dashboard_view, name='gyna'),
    ...
    path('pendientes-pagar/', views.pendientes_pagar, name='pendientes-pagar'),
    path('admin-view-request-distripen/', views.admin_pendientes_distribuidoras, name='admin-view-request-distripen'),
    path('solo-consultas/', views.solo_consultas, name='solo-consultas'),
    path('compras-no-entregadas/', views.compras_no_entregadas, name='compras-no-entregadas'),
    path('compras-entregadas/', views.compras_entregadas, name='compras-entregadas'),
    ...
    path('admin-view-request-asia/', views.admin_pendientes_asia, name='admin-view-request-asia'),
    ...
    path('mostrar-ordenes/', views.mostrar_ordenes_tienda, name='mostrar_ordenes_tienda'),
    path('orden/<int:id>/', views.detalle_orden, name='detalle_orden'),  # Para la vista de detalles de la orden
